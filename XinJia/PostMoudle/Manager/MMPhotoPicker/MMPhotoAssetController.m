...
@interface MMPhotoAssetController ()<UICollectionViewDelegate,UICollectionViewDataSource,HCPhotoEditViewControllerDelegate>
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_cropImageOption)
    {
        ...
        [MMPhotoUtil getImageWithAsset:asset completion:^(UIImage *image) {
            ...
            editController.imageEditBlock = ^(UIImage *editImage) {
                if (!self.completion) {
                    NSLog(@"警告:未设置回传!!!");
                    return;
                }
                ...
                [dictionary setObject:@(asset.mediaType) forKey:MMPhotoMediaType];
                [dictionary setObject:editImage forKey:MMPhotoOriginalImage];
                // 回传
